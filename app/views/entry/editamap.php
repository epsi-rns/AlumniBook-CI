<?php 
	...
	$orig_val = (empty($row['OID'])) ? 0: $row['OID'];
...
<div>
	...
	<legend>Alumna, Map Detail</legend>
		<table class="admintable" cellspacing="1">
			...
			<tr>
				<td width="150" class="key"><label>Organization/ Company/ Institution</label></td>
				<td><div id="OrganizationID"></div>
				<input type="button" onclick="xajax_modalOrg();" value="Select..." /></td>
			</tr>			
			<tr>
	...
	function submitbutton(task) {
		...
		if (f.id_org.value == "0")	{	
			alert( "You must provide an organization." );	
	...
	function runQuery() {
		...
		if (search!="") {	xajax_tableOrg(f.namesearchquery.value); }
	}	
